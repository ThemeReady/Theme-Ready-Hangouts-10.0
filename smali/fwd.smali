...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lfwd;->c:Z

    sput-boolean v1, Lfwd;->d:Z
    ...
    sput-object v0, Lfwd;->a:Ljava/lang/Object;

    sput-object v2, Lfwd;->g:Ljava/lang/String;

    sput-object v2, Lfwd;->h:Ljava/lang/Integer;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lfwd;->f:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lfwd;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1, v1}, Lfwd;->a(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-virtual {v1, v2, v0}, Lfwe;->a(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageInfo;)Z
...
.method public static a(Landroid/content/pm/PackageManager;)Z
    ...
    .prologue
    .line 0
    invoke-static {p0}, Lfwd;->b(Landroid/content/pm/PackageManager;)Z
    ...
    .line 9000
    sget-boolean v0, Lfwd;->c:Z

    if-eqz v0, :cond_1

    sget-boolean v0, Lfwd;->d:Z
...
.method public static b(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, v0}, Lfwd;->a(Landroid/content/Context;Ljava/lang/String;)Z
...
.method private static b(Landroid/content/pm/PackageManager;)Z
    ...
    .line 0
    sget-object v2, Lfwd;->a:Ljava/lang/Object;
    ...
    .line 8000
    sget-object v4, Lfwe;->a:Lfwe;

    .line 0
    const/4 v4, 0x1

    new-array v4, v4, [Lgcl;

    const/4 v5, 0x0

    sget-object v6, Lgjw;->a:[Lgcl;
    ...
    invoke-static {v3, v4}, Lfwe;->a(Landroid/content/pm/PackageInfo;[Lgcl;)Lgcl;
...
.method public static c(Landroid/content/Context;)I
    ...
    .line 1000
    sget-object v3, Lfwd;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    sget-object v5, Lfwd;->a:Ljava/lang/Object;

    monitor-enter v5

    :try_start_1
    sget-object v3, Lfwd;->g:Ljava/lang/String;
    ...
    sput-object v3, Lfwd;->g:Ljava/lang/String;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    sput-object v3, Lfwd;->h:Ljava/lang/Integer;
    :try_end_2
    ...
    :goto_2
    :try_start_3
    sget-object v3, Lfwd;->h:Ljava/lang/Integer;
    ...
    sget-object v2, Lfwd;->g:Ljava/lang/String;
    ...
    .line 2000
    sget-object v5, Lfwe;->a:Lfwe;

    .line 0
    invoke-static {p0}, Ldlm;->Q(Landroid/content/Context;)Z

    move-result v5

    if-eqz v5, :cond_8

    sget-object v5, Lgjw;->a:[Lgcl;

    invoke-static {v3, v5}, Lfwe;->a(Landroid/content/pm/PackageInfo;[Lgcl;)Lgcl;
    ...
    invoke-static {v5, v6}, Lfwe;->a(Landroid/content/pm/PackageInfo;[Lgcl;)Lgcl;
    ...
    new-array v6, v6, [Lgcl;

    const/4 v7, 0x0

    aput-object v5, v6, v7

    invoke-static {v3, v6}, Lfwe;->a(Landroid/content/pm/PackageInfo;[Lgcl;)Lgcl;
    :try_end_8
...
.method public static d(Landroid/content/Context;)V
    ...
    .line 6000
    sget-object v1, Lfvy;->d:Lfvy;

    .line 0
    const-string v2, "e"

    invoke-virtual {v1, p0, v0, v2}, Lfvy;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {v1, v0}, Lfvz;-><init>(I)V
    ...
    invoke-direct {v2, v0, v3, v1}, Lfwa;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
...
.method public static e(Landroid/content/Context;)V
    ...
    sget-object v0, Lfwd;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
