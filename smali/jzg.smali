...
.method public constructor <init>(Lcom/google/api/client/http/AbstractInputStreamContent;Lcom/google/api/client/http/HttpTransport;Lcom/google/api/client/http/HttpRequestInitializer;)V
    ...
    iput-object v0, p0, Ljzg;->k:Lcom/google/api/client/http/HttpHeaders;
    ...
    iput-object v0, p0, Ljzg;->d:Lcom/google/api/client/http/AbstractInputStreamContent;
    ...
    iput-object v0, p0, Ljzg;->f:Lcom/google/api/client/http/HttpTransport;
    ...
    :goto_0
    iput-object v0, p0, Ljzg;->e:Lcom/google/api/client/http/HttpRequestFactory;
...
.method private static a(Lcom/google/api/client/http/HttpRequest;)Lcom/google/api/client/http/HttpResponse;
    ...
    invoke-virtual {v0, p0}, Ljzb;->intercept(Lcom/google/api/client/http/HttpRequest;)V
...
.method private b(Lcom/google/api/client/http/GenericUrl;)Lcom/google/api/client/http/HttpResponse;
    ...
    .line 348
    iget-object v0, p0, Ljzg;->d:Lcom/google/api/client/http/AbstractInputStreamContent;

    .line 349
    iget-object v1, p0, Ljzg;->g:Lcom/google/api/client/http/HttpContent;
    ...
    iget-object v3, p0, Ljzg;->g:Lcom/google/api/client/http/HttpContent;

    aput-object v3, v1, v2

    const/4 v2, 0x1

    iget-object v3, p0, Ljzg;->d:Lcom/google/api/client/http/AbstractInputStreamContent;
    ...
    .line 355
    :goto_0
    iget-object v1, p0, Ljzg;->e:Lcom/google/api/client/http/HttpRequestFactory;

    iget-object v2, p0, Ljzg;->j:Ljava/lang/String;
    ...
    iget-object v2, p0, Ljzg;->k:Lcom/google/api/client/http/HttpHeaders;

    invoke-virtual {v1, v2}, Lcom/google/api/client/http/HttpHeaders;->putAll(Ljava/util/Map;)V

    .line 360
    invoke-direct {p0, v0}, Ljzg;->b(Lcom/google/api/client/http/HttpRequest;)Lcom/google/api/client/http/HttpResponse;

    move-result-object v1

    .line 363
    :try_start_0
    invoke-direct {p0}, Ljzg;->b()Z
    ...
    .line 364
    invoke-direct {p0}, Ljzg;->c()J

    move-result-wide v2

    iput-wide v2, p0, Ljzg;->o:J
...
.method private b(Lcom/google/api/client/http/HttpRequest;)Lcom/google/api/client/http/HttpResponse;
    ...
    .line 562
    :cond_0
    invoke-static {p1}, Ljzg;->a(Lcom/google/api/client/http/HttpRequest;)Lcom/google/api/client/http/HttpResponse;
...
.method private c()J
    ...
    iput-wide v0, p0, Ljzg;->h:J

    .line 497
    const/4 v0, 0x1

    iput-boolean v0, p0, Ljzg;->i:Z

    .line 499
    :cond_0
    iget-wide v0, p0, Ljzg;->h:J
...
.method private c(Lcom/google/api/client/http/GenericUrl;)Lcom/google/api/client/http/HttpResponse;
    ...
    .prologue
    .line 384
    invoke-direct {p0, p1}, Ljzg;->d(Lcom/google/api/client/http/GenericUrl;)Lcom/google/api/client/http/HttpResponse;
    ...
    .line 397
    iget-object v1, p0, Ljzg;->d:Lcom/google/api/client/http/AbstractInputStreamContent;

    invoke-virtual {v1}, Lcom/google/api/client/http/AbstractInputStreamContent;->getInputStream()Ljava/io/InputStream;

    move-result-object v1

    iput-object v1, p0, Ljzg;->m:Ljava/io/InputStream;

    .line 398
    iget-object v1, p0, Ljzg;->m:Ljava/io/InputStream;
    ...
    iget-object v2, p0, Ljzg;->m:Ljava/io/InputStream;
    ...
    iput-object v1, p0, Ljzg;->l:Lcom/google/api/client/http/HttpRequest;
    ...
    invoke-static {v2, v4, v5}, Ldlm;->b(Ljava/io/InputStream;J)Ljava/io/InputStream;
    ...
    iget-object v4, p0, Ljzg;->d:Lcom/google/api/client/http/AbstractInputStreamContent;
    ...
    iput-object v3, p0, Ljzg;->a:Ljava/lang/String;
    ...
    .line 3655
    iget-object v3, p0, Ljzg;->l:Lcom/google/api/client/http/HttpRequest;
    ...
    .line 3660
    iget-object v1, p0, Ljzg;->l:Lcom/google/api/client/http/HttpRequest;
    ...
    iget-object v2, p0, Ljzg;->l:Lcom/google/api/client/http/HttpRequest;

    invoke-direct {v1, p0, v2}, Ljzi;-><init>(Ljzg;Lcom/google/api/client/http/HttpRequest;)V
    ...
    invoke-static {v1}, Ljzg;->a(Lcom/google/api/client/http/HttpRequest;)Lcom/google/api/client/http/HttpResponse;
    ...
    .line 426
    iget-object v0, p0, Ljzg;->m:Ljava/io/InputStream;
    ...
    .line 3601
    iget-object v2, p0, Ljzg;->t:[B

    if-nez v2, :cond_9

    .line 3602
    iget-object v2, p0, Ljzg;->q:Ljava/lang/Byte;
    ...
    iput-object v4, p0, Ljzg;->t:[B

    .line 3604
    iget-object v4, p0, Ljzg;->q:Ljava/lang/Byte;

    if-eqz v4, :cond_16

    .line 3605
    iget-object v4, p0, Ljzg;->t:[B

    const/4 v5, 0x0

    iget-object v6, p0, Ljzg;->q:Ljava/lang/Byte;
    ...
    .line 3629
    :goto_8
    iget-object v4, p0, Ljzg;->m:Ljava/io/InputStream;

    iget-object v5, p0, Ljzg;->t:[B

    add-int/lit8 v6, v1, 0x1

    sub-int/2addr v6, v3

    invoke-static {v4, v5, v6, v3}, Ldlm;->a(Ljava/io/InputStream;[BII)I
    ...
    iput-object v2, p0, Ljzg;->q:Ljava/lang/Byte;
    ...
    iput-object v2, p0, Ljzg;->a:Ljava/lang/String;
    ...
    .line 3651
    iget-wide v4, p0, Ljzg;->o:J

    int-to-long v6, v1

    add-long/2addr v4, v6

    iput-wide v4, p0, Ljzg;->r:J
    ...
    .line 3621
    iget-object v3, p0, Ljzg;->q:Ljava/lang/Byte;
    ...
    invoke-direct {p0, v1}, Ljzg;->b(Lcom/google/api/client/http/HttpRequest;)Lcom/google/api/client/http/HttpResponse;
...
.method private d(Lcom/google/api/client/http/GenericUrl;)Lcom/google/api/client/http/HttpResponse;
    ...
    .line 511
    iget-object v0, p0, Ljzg;->g:Lcom/google/api/client/http/HttpContent;
    ...
    .line 514
    iget-object v1, p0, Ljzg;->k:Lcom/google/api/client/http/HttpHeaders;
...
.method public a(Lcom/google/api/client/http/GenericUrl;)Lcom/google/api/client/http/HttpResponse;
    ...
    .line 333
    iget-boolean v0, p0, Ljzg;->n:Z

    if-eqz v0, :cond_1

    .line 334
    invoke-direct {p0, p1}, Ljzg;->b(Lcom/google/api/client/http/GenericUrl;)Lcom/google/api/client/http/HttpResponse;
    ...
    .line 336
    :cond_1
    invoke-direct {p0, p1}, Ljzg;->c(Lcom/google/api/client/http/GenericUrl;)Lcom/google/api/client/http/HttpResponse;
...
.method public a(Lcom/google/api/client/http/HttpContent;)Ljzg;
    .locals 0

    .prologue
    .line 708
    iput-object p1, p0, Ljzg;->g:Lcom/google/api/client/http/HttpContent;

    .line 709
    return-object p0
.end method

.method public a(Z)Ljzg;
    .locals 1
...
.method a()V
    ...
    .prologue
    .line 679
    iget-object v0, p0, Ljzg;->l:Lcom/google/api/client/http/HttpRequest;
