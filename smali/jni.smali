...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljql;Ljava/lang/String;Ljava/lang/String;JJLjnj;Ljnt;)V
    .locals 1
    ...
    .line 51
    iput-object p3, p0, Ljni;->l:Ljava/lang/String;

    .line 52
    iput-object p4, p0, Ljni;->m:Ljava/lang/String;

    .line 53
    iput-wide p5, p0, Ljni;->n:J

    .line 54
    iput-wide p7, p0, Ljni;->o:J

    .line 55
    iput-object p9, p0, Ljni;->j:Ljnj;

    .line 56
    iput-object p10, p0, Ljni;->k:Ljnt;
    ...
    iput-object v0, p0, Ljni;->q:Lorg/chromium/net/CronetEngine;
...
.method public a()V
    ...
    .line 64
    invoke-virtual {p0}, Ljni;->j()Ljql;

    move-result-object v1

    iget-object v2, p0, Ljni;->l:Ljava/lang/String;

    invoke-interface {v1, v2}, Ljql;->a(Ljava/lang/String;)Ljava/util/Map;
    ...
    iget-wide v2, p0, Ljni;->n:J

    iget-wide v4, p0, Ljni;->o:J

    const-wide/16 v6, 0x1

    sub-long/2addr v4, v6

    iget-wide v6, p0, Ljni;->o:J
    ...
    iget-object v1, p0, Ljni;->l:Ljava/lang/String;

    iget-object v3, p0, Ljni;->i:Lorg/chromium/net/UrlRequest$Callback;

    .line 1242
    iget-object v4, p0, Ljmw;->b:Ljmz;

    .line 68
    iget-object v5, p0, Ljni;->q:Lorg/chromium/net/CronetEngine;
    ...
    iget-object v1, p0, Ljni;->m:Ljava/lang/String;
    ...
    iget-wide v6, p0, Ljni;->n:J

    sub-long/2addr v4, v6

    invoke-direct {v0, p0, v4, v5}, Ljnk;-><init>(Ljni;J)V

    .line 2242
    iget-object v1, p0, Ljmw;->b:Ljmz;
    ...
    iput-object v0, p0, Ljni;->p:Lorg/chromium/net/UrlRequest;
...
.method protected b()Lorg/chromium/net/UrlRequest;
    ...
    .prologue
    .line 85
    iget-object v0, p0, Ljni;->p:Lorg/chromium/net/UrlRequest;
