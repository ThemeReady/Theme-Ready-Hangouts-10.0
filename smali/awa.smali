...
.field private static final d:Lawc;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lawa;->c:Ljava/util/Set;
    ...
    sput-object v0, Lawa;->e:Ljava/util/Set;

    .line 82
    invoke-static {v4}, Lbad;->a(I)Ljava/util/Queue;

    move-result-object v0

    sput-object v0, Lawa;->f:Ljava/util/Queue;

    return-void
.end method

.method public constructor <init>(Landroid/util/DisplayMetrics;Laqq;Laql;)V
    .locals 1
    ...
    iput-object v0, p0, Lawa;->h:Landroid/util/DisplayMetrics;
...
.method private a(Ljava/io/InputStream;)I
    ...
    iget-object v2, p0, Lawa;->i:Laql;

    invoke-direct {v1, p1, v2}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;-><init>(Ljava/io/InputStream;Laql;)V
...
.method private a(Ljava/io/InputStream;Lane;)Landroid/graphics/Bitmap$Config;
    .locals 4
...
.method private static a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lawc;)Landroid/graphics/Bitmap;
    .locals 9
    ...
    .line 4060
    sget-object v3, Lawn;->a:Ljava/util/concurrent/locks/Lock;
    ...
    .line 5060
    sget-object v1, Lawn;->a:Ljava/util/concurrent/locks/Lock;
    ...
    .line 5488
    invoke-static {p1}, Lawa;->b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
...
.method private static b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lawa;->a(Landroid/graphics/Bitmap;)Ljava/lang/String;
...
.method private b(Ljava/io/InputStream;)Z
    ...
    .line 356
    sget-object v1, Lawa;->e:Ljava/util/Set;
...
.method private static declared-synchronized c()Landroid/graphics/BitmapFactory$Options;
    ...
    :try_start_0
    sget-object v2, Lawa;->f:Ljava/util/Queue;
    ...
    .line 504
    :try_start_1
    sget-object v0, Lawa;->f:Ljava/util/Queue;
    ...
    .line 508
    invoke-static {v0}, Lawa;->d(Landroid/graphics/BitmapFactory$Options;)V
    :try_end_2
...
.method private static c(Landroid/graphics/BitmapFactory$Options;)V
    ...
    .prologue
    .line 515
    invoke-static {p0}, Lawa;->d(Landroid/graphics/BitmapFactory$Options;)V

    .line 516
    sget-object v1, Lawa;->f:Ljava/util/Queue;
...
# virtual methods
.method public a(Ljava/io/InputStream;IILanm;)Laqe;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public a(Ljava/io/InputStream;IILanm;Lawc;)Laqe;
    .locals 18
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v2, v3}, Ldlm;->a(ZLjava/lang/String;)V

    .line 150
    move-object/from16 v0, p0

    iget-object v2, v0, Lawa;->i:Laql;

    const/high16 v3, 0x10000

    const-class v4, [B

    invoke-virtual {v2, v3, v4}, Laql;->a(ILjava/lang/Class;)Ljava/lang/Object;
    ...
    .line 151
    invoke-static {}, Lawa;->c()Landroid/graphics/BitmapFactory$Options;
    ...
    .line 154
    sget-object v3, Lawa;->a:Lanj;

    move-object/from16 v0, p4

    invoke-virtual {v0, v3}, Lanm;->a(Lanj;)Ljava/lang/Object;
    ...
    .line 155
    sget-object v4, Lawa;->b:Lanj;

    move-object/from16 v0, p4

    invoke-virtual {v0, v4}, Lanm;->a(Lanj;)Ljava/lang/Object;
    ...
    invoke-static {v0, v10, v1}, Lawa;->a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lawc;)Landroid/graphics/Bitmap;
    ...
    .line 1177
    invoke-direct/range {p0 .. p1}, Lawa;->a(Ljava/io/InputStream;)I
    ...
    invoke-direct {v0, v1, v3}, Lawa;->a(Ljava/io/InputStream;Lane;)Landroid/graphics/Bitmap$Config;
    ...
    .line 2316
    :cond_2
    invoke-direct/range {p0 .. p1}, Lawa;->b(Ljava/io/InputStream;)Z
    ...
    .line 2318
    invoke-static {v10}, Lawa;->a(Landroid/graphics/BitmapFactory$Options;)Z
    ...
    .line 2496
    invoke-interface {v4, v6, v8, v3}, Laqq;->b(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    iget-object v3, v0, Lawa;->g:Laqq;

    move-object/from16 v0, p5

    invoke-interface {v0, v3, v4}, Lawc;->a(Laqq;Landroid/graphics/Bitmap;)V
    ...
    .line 3447
    invoke-static {v4}, Lawa;->a(Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    .line 3449
    invoke-static {v10}, Lawa;->b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
    ...
    iget-object v3, v0, Lawa;->h:Landroid/util/DisplayMetrics;
    ...
    invoke-static {v3, v4, v12}, Lawn;->a(Laqq;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    iget-object v5, v0, Lawa;->g:Laqq;

    invoke-interface {v5, v4}, Laqq;->a(Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v3, v4}, Lavm;->a(Landroid/graphics/Bitmap;Laqq;)Lavm;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 162
    invoke-static {v10}, Lawa;->c(Landroid/graphics/BitmapFactory$Options;)V

    .line 163
    move-object/from16 v0, p0

    iget-object v4, v0, Lawa;->i:Laql;

    const-class v5, [B

    invoke-virtual {v4, v2, v5}, Laql;->a(Ljava/lang/Object;Ljava/lang/Class;)V
    ...
    :cond_8
    :try_start_1
    invoke-virtual {v4, v9, v7, v6, v8}, Lavs;->a(IIII)F
    ...
    :cond_b
    :try_start_2
    invoke-virtual {v4, v7, v9, v6, v8}, Lavs;->a(IIII)F
    ...
    sget-object v13, Lawa;->c:Ljava/util/Set;
