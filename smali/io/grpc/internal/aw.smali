...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v2, v0, v0, v3}, Lio/grpc/internal/aw;-><init>(Ljava/lang/String;IILoan;)V
    ...
    sget-object v3, Loan;->p:Loan;

    invoke-direct {v1, v2, v7, v7, v3}, Lio/grpc/internal/aw;-><init>(Ljava/lang/String;IILoan;)V
    ...
    invoke-direct {v1, v2, v8, v8, v3}, Lio/grpc/internal/aw;-><init>(Ljava/lang/String;IILoan;)V
    ...
    invoke-direct {v1, v2, v9, v9, v3}, Lio/grpc/internal/aw;-><init>(Ljava/lang/String;IILoan;)V
    ...
    invoke-direct {v1, v2, v10, v10, v3}, Lio/grpc/internal/aw;-><init>(Ljava/lang/String;IILoan;)V
    ...
    sget-object v5, Loan;->p:Loan;

    invoke-direct {v1, v2, v3, v4, v5}, Lio/grpc/internal/aw;-><init>(Ljava/lang/String;IILoan;)V
    ...
    sget-object v5, Loan;->k:Loan;

    const-string v6, "Bandwidth exhausted"

    invoke-virtual {v5, v6}, Loan;->a(Ljava/lang/String;)Loan;
...
.method private constructor <init>(Ljava/lang/String;IILoan;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    :goto_0
    invoke-virtual {p4, v0}, Loan;->b(Ljava/lang/String;)Loan;

    move-result-object v0

    iput-object v0, p0, Lio/grpc/internal/aw;->q:Loan;
...
.method public static a(J)Loan;
    ...
    invoke-direct {v0}, Lio/grpc/internal/aw;->b()Loan;
...
.method private b()Loan;
    .locals 1

    .prologue
    .line 234
    iget-object v0, p0, Lio/grpc/internal/aw;->q:Loan;
