...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ljbl;->b:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, Ljbl;->c:Ljava/util/Map;
    ...
    .line 95
    iget-object v0, p0, Ljbl;->c:Ljava/util/Map;

    const-string v1, "position"

    new-array v2, v6, [Landroid/util/Property;

    sget-object v3, Ljbr;->e:Landroid/util/Property;

    aput-object v3, v2, v4

    sget-object v3, Ljbr;->f:Landroid/util/Property;
...
.method private static a(Ljbm;Landroid/util/Property;D)F
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 389
    invoke-virtual {p0, p1}, Ljbm;->a(Landroid/util/Property;)Z
    ...
    invoke-direct {v0, v1}, Ljbn;-><init>(Ljava/lang/String;)V
    ...
    .line 393
    sget-object v1, Ljbr;->e:Landroid/util/Property;
    ...
    .line 395
    :cond_2
    sget-object v1, Ljbr;->f:Landroid/util/Property;
...
.method private a(Landroid/content/Context;ILjava/util/Map;FF)Landroid/animation/Animator;
    ...
    invoke-direct/range {v0 .. v6}, Ljbm;-><init>(Ljbl;Landroid/content/Context;ILjava/util/Map;FF)V
    ...
    .line 161
    invoke-direct {p0, v0}, Ljbl;->b(Ljbm;)Ljava/util/Collection;
    ...
    invoke-direct {v2, p0, v0}, Ljbo;-><init>(Ljbl;Ljbm;)V
    ...
    invoke-direct {v1, v0}, Ljbn;-><init>(Ljava/lang/Throwable;)V
...
.method private a(Ljbm;Lorg/json/JSONObject;Ljava/util/Collection;)V
    .locals 26
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v2, v0, Ljbm;->d:Ljava/util/Map;
    ...
    iget-object v2, v0, Ljbl;->c:Ljava/util/Map;
    ...
    iget-object v4, v0, Ljbl;->d:Ljava/util/Map;
    ...
    invoke-static {v0, v1, v8, v9}, Ljbl;->a(Ljbm;Landroid/util/Property;D)F
    ...
    invoke-interface {v11, v7, v8}, Ljbq;->a(Landroid/animation/Keyframe;Landroid/animation/Keyframe;)V
    ...
    invoke-direct {v7, v9, v11, v0, v8}, Ljbp;-><init>(FFFF)V
...
.method private b(Ljbm;)Ljava/util/Collection;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 300
    iget-object v0, p1, Ljbm;->c:Lorg/json/JSONObject;
    ...
    invoke-direct {p0, p1, v4, v2}, Ljbl;->a(Ljbm;Lorg/json/JSONObject;Ljava/util/Collection;)V
...
.method public a(Landroid/content/Context;ILjava/util/Map;)Landroid/animation/Animator;
    ...
    .line 122
    invoke-direct/range {v0 .. v5}, Ljbl;->a(Landroid/content/Context;ILjava/util/Map;FF)Landroid/animation/Animator;
...
.method a(Ljbm;)V
    ...
    .line 257
    iget-object v1, p1, Ljbm;->d:Ljava/util/Map;
    ...
    .line 1275
    iget-object v1, p0, Ljbl;->d:Ljava/util/Map;
    ...
    .line 1278
    iget-object v1, p0, Ljbl;->c:Ljava/util/Map;
    ...
    .line 1280
    iget-object v2, p0, Ljbl;->d:Ljava/util/Map;
    ...
    invoke-virtual {p1, v9}, Ljbm;->a(Landroid/util/Property;)Z
    ...
    .line 1282
    invoke-static {p1, v1, v10, v11}, Ljbl;->a(Ljbm;Landroid/util/Property;D)F
    ...
    invoke-virtual {p1, v10}, Ljbm;->a(Landroid/util/Property;)Z
    ...
    .line 1288
    invoke-static {p1, v11, v12, v13}, Ljbl;->a(Ljbm;Landroid/util/Property;D)F
