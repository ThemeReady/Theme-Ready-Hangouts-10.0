...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbkm;->n:Ljava/util/Map;
...
.method public static a(Lbji;)Landroid/graphics/Bitmap;
    .locals 4

    .prologue
    .line 73
    sget-object v0, Lbkm;->n:Ljava/util/Map;
    ...
    .line 1091
    sget-object v0, Lbkn;->a:[I

    invoke-virtual {p0}, Lbji;->ordinal()I
    ...
    .line 1093
    invoke-static {v2, v0}, Lbkm;->a(Landroid/graphics/Canvas;Landroid/graphics/Bitmap;)V

    move-object v0, v1

    .line 79
    :goto_0
    sget-object v1, Lbkm;->n:Ljava/util/Map;
...
.method public static a(Lbjy;Ljava/util/List;Z)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 265
    iget-object v4, v0, Ldhu;->h:Ljava/lang/String;
    ...
    invoke-direct {v0, v4, v6}, Lfml;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 279
    invoke-virtual {v0, v7}, Lfml;->d(Z)Lfml;

    move-result-object v0

    invoke-direct {v5, v0, v8, v7, v8}, Lbmt;-><init>(Lfml;Lbmw;ZLjava/lang/Object;)V
    ...
    invoke-virtual {v0, v5}, Lewe;->c(Levi;)V
...
.method public static a(Landroid/graphics/Bitmap;)Z
    ...
    .line 298
    invoke-interface {v0, p0}, Lbob;->a(Landroid/graphics/Bitmap;)Z

    move-result v0

    if-nez v0, :cond_0

    sget-object v0, Lbkm;->f:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbkm;->g:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbkm;->h:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbkm;->i:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbkm;->j:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbkm;->k:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbkm;->l:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbkm;->m:Landroid/graphics/Bitmap;
...
.method public static b()Landroid/graphics/Bitmap;
    ...
    invoke-static {v0}, Lfmm;->a(I)Landroid/graphics/Bitmap;

    move-result-object v0

    sput-object v0, Lbkm;->f:Landroid/graphics/Bitmap;
...
.method public static c()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbkm;->g:Landroid/graphics/Bitmap;
...
.method public static d()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbkm;->h:Landroid/graphics/Bitmap;
...
.method public static e()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbkm;->i:Landroid/graphics/Bitmap;
...
.method public static f()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbkm;->j:Landroid/graphics/Bitmap;
...
.method public static g()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbkm;->k:Landroid/graphics/Bitmap;
...
.method public static h()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbkm;->l:Landroid/graphics/Bitmap;
...
.method public static i()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbkm;->m:Landroid/graphics/Bitmap;
