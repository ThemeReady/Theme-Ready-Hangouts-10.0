...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfav;->b:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    sput-object v0, Lfav;->c:Landroid/net/Uri;
...
.method public constructor <init>(Landroid/telephony/SmsManager;)V
    ...
    iput-object v0, p0, Lfav;->e:Ljava/util/concurrent/ConcurrentHashMap;

    .line 49
    iput-object p1, p0, Lfav;->d:Landroid/telephony/SmsManager;

    .line 50
    return-void
.end method

.method private a(Landroid/content/Context;Ljava/lang/String;Lahr;Z)Laii;
    .locals 14
    ...
    invoke-virtual {p0, p1, v0}, Lfav;->a(Landroid/content/Context;Lahr;)Landroid/net/Uri;
    ...
    invoke-direct {v6, v2, v0}, Lfaw;-><init>(Landroid/net/Uri;Z)V

    .line 135
    sget-object v3, Lfav;->b:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 141
    :try_start_0
    iget-object v3, p0, Lfav;->e:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 144
    sget-object v3, Lfav;->c:Landroid/net/Uri;
    ...
    invoke-virtual {p0, p1, v2, v0, v4}, Lfav;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Landroid/content/Intent;)V

    .line 150
    const-class v2, Lbik;

    invoke-static {p1, v2}, Ljua;->a(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {v2, v3, v4, v5}, Lbik;->a(Ljava/lang/String;J)J
    ...
    invoke-static {v2, v3, v7}, Lfns;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :cond_1
    :try_start_3
    iget-object v2, p0, Lfav;->e:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 5302
    :pswitch_0
    iget-object v2, v6, Lfaw;->a:Landroid/net/Uri;
    ...
    .line 6302
    iget-object v3, v6, Lfaw;->a:Landroid/net/Uri;
    ...
    .line 7302
    :cond_5
    iget-boolean v2, v6, Lfaw;->b:Z

    .line 2218
    if-eqz v2, :cond_6

    .line 8302
    iget-object v2, v6, Lfaw;->e:[B

    .line 2220
    invoke-virtual {p0, v2}, Lfav;->a([B)Laii;
    ...
    invoke-direct {v2, v3}, Lfaq;-><init>(I)V
...
# virtual methods
.method public a(Landroid/content/Context;Laij;)Laii;
    .locals 2
    ...
    invoke-direct {p0, p1, v0, p2, v1}, Lfav;->a(Landroid/content/Context;Ljava/lang/String;Lahr;Z)Laii;
...
.method a([B)Laii;
    ...
    invoke-direct {v0, p1}, Laib;-><init>([B)V
...
.method a(Landroid/content/Context;Lahr;)Landroid/net/Uri;
    .locals 6
    ...
    invoke-direct {v2, p1, p2}, Lahv;-><init>(Landroid/content/Context;Lahr;)V

    invoke-virtual {v2}, Lahv;->a()[B
    ...
    :goto_1
    invoke-static {v4, v2, v0}, Lfns;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, v2}, Lfax;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v2, v3, v0}, Lfaq;-><init>(ILjava/lang/Throwable;)V
...
.method public a(JII[B)V
    ...
    .line 75
    iget-object v0, p0, Lfav;->e:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 78
    :try_start_0
    invoke-virtual {v0, p3, p4, p5}, Lfaw;->a(II[B)V
...
.method a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Landroid/content/Intent;)V
    ...
    .line 234
    iget-object v0, p0, Lfav;->d:Landroid/telephony/SmsManager;
...
.method public a(Landroid/content/Context;[BLjava/lang/String;I)V
    ...
    invoke-direct {v0, v1, p2, v2}, Lahr;-><init>(I[BI)V

    .line 115
    const/4 v1, 0x0

    invoke-direct {p0, p1, p3, v0, v1}, Lfav;->a(Landroid/content/Context;Ljava/lang/String;Lahr;Z)Laii;
