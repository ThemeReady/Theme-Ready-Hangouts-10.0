...
.method private constructor <init>(Landroid/telecom/PhoneAccountHandle;Landroid/telecom/RemoteConference;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)V
    ...
    iput-object v0, p0, Lfha;->c:Landroid/telecom/RemoteConference$Callback;

    .line 51
    iput-object p2, p0, Lfha;->a:Landroid/telecom/RemoteConference;

    .line 52
    iput-object p3, p0, Lfha;->b:Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;
    ...
    invoke-virtual {p0, v0}, Lfha;->setConnectionCapabilities(I)V
    ...
    invoke-virtual {p0, v0}, Lfha;->a(I)V

    .line 55
    iget-object v0, p0, Lfha;->c:Landroid/telecom/RemoteConference$Callback;
    ...
    .line 57
    invoke-static {v0, p3}, Lfgv;->a(Landroid/telecom/RemoteConnection;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)Lffa;
    ...
    .line 60
    invoke-virtual {p0, v2}, Lfha;->addConnection(Landroid/telecom/Connection;)Z
...
.method public static a(Landroid/telecom/RemoteConference;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)Lfha;
    .locals 5
    ...
    .line 34
    invoke-static {v0, p1}, Lfgv;->a(Landroid/telecom/RemoteConnection;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)Lffa;
    ...
    invoke-direct {v1, v0, p0, p1}, Lfha;-><init>(Landroid/telecom/PhoneAccountHandle;Landroid/telecom/RemoteConference;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)V
...
.method a(I)V
    ...
    .line 139
    :pswitch_1
    invoke-virtual {p0}, Lfha;->setOnHold()V

    goto :goto_0

    .line 142
    :pswitch_2
    invoke-virtual {p0}, Lfha;->setActive()V
...
.method public onAudioStateChanged(Landroid/telecom/AudioState;)V
    ...
    .line 130
    iget-object v0, p0, Lfha;->a:Landroid/telecom/RemoteConference;
...
.method public onSeparate(Landroid/telecom/Connection;)V
    ...
    .line 84
    instance-of v1, v0, Lfgv;

    if-eqz v1, :cond_0

    .line 85
    iget-object v1, p0, Lfha;->a:Landroid/telecom/RemoteConference;

    check-cast v0, Lfgv;

    invoke-virtual {v0}, Lfgv;->n()Landroid/telecom/RemoteConnection;
