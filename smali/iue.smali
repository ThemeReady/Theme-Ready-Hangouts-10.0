...
# direct methods
.method constructor <init>(Ljava/util/concurrent/ScheduledExecutorService;Liuh;)V
    .locals 1
    ...
    iput-object v0, p0, Liue;->b:Ljava/util/concurrent/ScheduledExecutorService;
...
.method private final a(Ljava/lang/Runnable;)Ljava/lang/Runnable;
    ...
    invoke-direct {v0, p0, p1}, Liuf;-><init>(Liue;Ljava/lang/Runnable;)V
...
.method private final a(Ljava/util/Collection;)Ljava/util/List;
    ...
    .line 66
    invoke-direct {p0, v0}, Liue;->a(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Callable;
...
.method private final a(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Callable;
    ...
    invoke-direct {v0, p0, p1}, Liug;-><init>(Liue;Ljava/util/concurrent/Callable;)V
...
.method public awaitTermination(JLjava/util/concurrent/TimeUnit;)Z
    ...
    .prologue
    .line 135
    iget-object v0, p0, Liue;->b:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public execute(Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0, p1}, Liue;->a(Ljava/lang/Runnable;)Ljava/lang/Runnable;
...
.method public invokeAll(Ljava/util/Collection;)Ljava/util/List;
    ...
    invoke-direct {p0, p1}, Liue;->a(Ljava/util/Collection;)Ljava/util/List;
...
.method public schedule(Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    ...
    invoke-direct {p0, p1}, Liue;->a(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Callable;
