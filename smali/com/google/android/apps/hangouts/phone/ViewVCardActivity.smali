...
.method public constructor <init>()V
    ...
    iget-object v1, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->F:Ljyb;

    invoke-direct {v0, p0, v1}, Liyp;-><init>(Landroid/app/Activity;Ljxb;)V

    iget-object v1, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->E:Ljua;
    ...
    iput-object v0, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->n:Lixv;
    ...
    invoke-direct {v0, p0}, Ldsu;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;)V
    ...
    invoke-direct {v0, p0}, Ldsq;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;)V
...
.method private a(Landroid/net/Uri;ILakb;ZLjava/util/List;)Z
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p2}, Lakg;-><init>(I)V

    .line 564
    invoke-virtual {v1, p3}, Lakc;->a(Lakb;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Lakq; {:try_start_0 .. :try_end_0} :catch_4
    .catch Lakn; {:try_start_0 .. :try_end_0} :catch_6

    .line 567
    :try_start_1
    invoke-virtual {v1, v3}, Lakc;->a(Ljava/io/InputStream;)V
    :try_end_1
    .catch Lakr; {:try_start_1 .. :try_end_1} :catch_2
    ...
    .catch Lakq; {:try_start_2 .. :try_end_2} :catch_4
    .catch Lakn; {:try_start_2 .. :try_end_2} :catch_6
    ...
    .catch Lakq; {:try_start_3 .. :try_end_3} :catch_4
    .catch Lakn; {:try_start_3 .. :try_end_3} :catch_6
    ...
    invoke-direct {v1, p2}, Lakh;-><init>(I)V
    ...
    invoke-virtual {v1, v3}, Lakc;->a(Ljava/io/InputStream;)V
    :try_end_6
    .catch Lakr; {:try_start_6 .. :try_end_6} :catch_7
    ...
    .catch Lakq; {:try_start_7 .. :try_end_7} :catch_4
    .catch Lakn; {:try_start_7 .. :try_end_7} :catch_6
    ...
    .catch Lakq; {:try_start_8 .. :try_end_8} :catch_4
    .catch Lakn; {:try_start_8 .. :try_end_8} :catch_6
    ...
    .catch Lakq; {:try_start_a .. :try_end_a} :catch_4
    .catch Lakn; {:try_start_a .. :try_end_a} :catch_6
    ...
    .catch Lakq; {:try_start_b .. :try_end_b} :catch_4
    .catch Lakn; {:try_start_b .. :try_end_b} :catch_6
    ...
    invoke-direct {v1, v4}, Lakn;-><init>(Ljava/lang/String;)V
    ...
    .catch Lakq; {:try_start_d .. :try_end_d} :catch_4
    .catch Lakn; {:try_start_d .. :try_end_d} :catch_6
...
.method public static synthetic a(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;Landroid/net/Uri;ILakb;ZLjava/util/List;)Z
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->a(Landroid/net/Uri;ILakb;ZLjava/util/List;)Z
...
# virtual methods
.method public a(Lajf;Ljava/util/List;Ljava/util/List;)V
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 153
    invoke-virtual {p1}, Lajf;->b()Ljava/lang/String;
    ...
    invoke-virtual {v1, v3, v0}, Lkk;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 3618
    iget-object v0, p1, Lajf;->a:Ljava/util/List;
    ...
    invoke-virtual {v0}, Lajs;->b()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lajs;->d()Ljava/lang/String;
    ...
    invoke-virtual {v1, v5, v6}, Lkk;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v5, v0}, Lkk;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 3622
    :cond_4
    iget-object v0, p1, Lajf;->b:Ljava/util/List;
    ...
    .line 3626
    :cond_8
    iget-object v0, p1, Lajf;->c:Ljava/util/List;
    ...
    invoke-virtual {v0}, Laju;->h()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Laju;->j()Ljava/lang/String;
    ...
    .line 226
    :cond_9
    invoke-virtual {v0}, Laju;->c()Ljava/lang/String;
    ...
    .line 234
    :cond_b
    invoke-virtual {v0}, Laju;->e()Ljava/lang/String;
    ...
    .line 238
    :cond_c
    invoke-virtual {v0}, Laju;->f()Ljava/lang/String;
    ...
    .line 242
    :cond_d
    invoke-virtual {v0}, Laju;->g()Ljava/lang/String;
    ...
    invoke-virtual {v1, v6, v5}, Lkk;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 3634
    :cond_12
    iget-object v0, p1, Lajf;->e:Ljava/util/List;
    ...
    invoke-virtual {v0}, Lajn;->b()Ljava/lang/String;
    ...
    .line 4630
    :cond_14
    iget-object v0, p1, Lajf;->d:Ljava/util/List;
    ...
    invoke-virtual {v0}, Lajr;->c()Ljava/lang/String;
    ...
    .line 295
    invoke-virtual {v5, v6, v1}, Lkk;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v5, v1, v0}, Lkk;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 4642
    :cond_17
    iget-object v0, p1, Lajf;->f:Ljava/util/List;
    ...
    invoke-virtual {v0}, Lajx;->b()Ljava/lang/String;
    ...
    invoke-virtual {v2, v4, v0}, Lkk;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 6233
    iget-object v0, v0, Laji;->a:Ljava/lang/String;
    ...
    invoke-virtual {v1, v2, v0}, Lkk;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v0, v2}, Lkk;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 6614
    :cond_1a
    iget-object v0, p1, Lajf;->g:Ljava/util/List;
    ...
    .line 341
    invoke-virtual {v0}, Lajq;->b()Ljava/lang/String;
    ...
    invoke-virtual {v2, v0, v4}, Lkk;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public a(Landroid/net/Uri;Lakj;)V
    .locals 6
    ...
    invoke-static {v0}, Laje;->a(Ljava/lang/String;)I
    ...
    invoke-direct {v3, v2, v1}, Lajy;-><init>(ILandroid/accounts/Account;)V
    ...
    invoke-direct {v0, p0, v1}, Laka;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;Landroid/os/Handler;)V

    invoke-virtual {v3, v0}, Lajy;->a(Laka;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->a(Landroid/net/Uri;ILakb;ZLjava/util/List;)Z
    :try_end_0
    .catch Lakp; {:try_start_0 .. :try_end_0} :catch_0
...
.method public c(I)Landroid/net/Uri;
    ...
    .line 446
    sget-object v0, Lchh;->bA:Ljava/util/Random;
    ...
    invoke-static {v4, v5, v0}, Lfns;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_3
    ...
    invoke-static {v3, v4, v0}, Lfns;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {v2, p0, v0}, Ldss;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;Landroid/net/Uri;)V
    ...
    .line 135
    :goto_1
    invoke-virtual {p0}, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->g()Lth;

    move-result-object v0

    .line 136
    invoke-virtual {v0, v4}, Lth;->b(Z)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    iget-object v0, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->n:Lixv;
    ...
    invoke-direct {v0, p0}, Ldsr;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;)V
    ...
    .line 7436
    invoke-virtual {v0, v1}, Ldsr;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
