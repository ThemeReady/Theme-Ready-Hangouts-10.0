...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lfiv;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;->a:Lfiv;
...
# virtual methods
.method public a()Lfiv;
    .locals 1

    .prologue
    .line 110
    iget-object v0, p0, Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;->a:Lfiv;
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p2}, Lfiv;->a(Ljava/io/PrintWriter;)V
...
.method public onConference(Landroid/telecom/Connection;Landroid/telecom/Connection;)V
    ...
    invoke-interface {v0, v1}, Lfem;->a(Lfem;)V
...
.method public onCreate()V
    ...
    invoke-static {p0, v0, v3}, Ldlm;->a(Landroid/content/Context;Ljava/lang/String;Z)Z
...
.method public onCreateIncomingConnection(Landroid/telecom/PhoneAccountHandle;Landroid/telecom/ConnectionRequest;)Landroid/telecom/Connection;
    ...
    invoke-static {p0, v0, v1}, Ldlm;->a(Landroid/content/Context;Ljava/lang/String;Z)Z
    ...
    invoke-direct {v0, p0, v3}, Lfff;-><init>(Landroid/content/Context;I)V
    ...
    .line 2215
    invoke-static {v4}, Lffy;->a(Landroid/os/Bundle;)Lffy;
    ...
    invoke-virtual {v0, p0, p2, v3, v1}, Lffu;->a(Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;Landroid/telecom/ConnectionRequest;Lfff;Landroid/os/PowerManager$WakeLock;)Lffa;
    :try_end_0
    ...
    invoke-direct {v0, p0, p0, p2, v3}, Lfft;-><init>(Landroid/content/Context;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;Landroid/telecom/ConnectionRequest;Lfff;)V

    .line 92
    invoke-virtual {v0}, Lfft;->a()Lffa;
    :try_end_1
...
.method public onCreateOutgoingConnection(Landroid/telecom/PhoneAccountHandle;Landroid/telecom/ConnectionRequest;)Landroid/telecom/Connection;
    ...
    .line 1066
    invoke-static {p0}, Lfhc;->a(Landroid/content/Context;)I

    move-result v3

    invoke-direct {v2, p0, v3}, Lfgm;-><init>(Landroid/content/Context;I)V

    invoke-direct {v1, p0, p2, v2, v4}, Lfgp;-><init>(Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;Landroid/telecom/ConnectionRequest;Lfgm;Z)V

    .line 1068
    new-instance v2, Lffa;

    invoke-direct {v2, v1}, Lffa;-><init>(Lfgp;)V

    .line 1071
    new-instance v1, Lfgo;

    invoke-direct {v1, v0, v2}, Lfgo;-><init>(Landroid/content/Context;Lffa;)V
...
.method public onRemoteConferenceAdded(Landroid/telecom/RemoteConference;)V
    ...
    .line 101
    invoke-static {p1, p0}, Lfha;->a(Landroid/telecom/RemoteConference;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)Lfha;
