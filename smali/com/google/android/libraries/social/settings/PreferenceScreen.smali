...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Ljsh;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private a(Landroid/os/Bundle;)V
    ...
    .line 169
    :cond_1
    invoke-virtual {p0}, Lcom/google/android/libraries/social/settings/PreferenceScreen;->B()Ljsl;

    move-result-object v0

    invoke-virtual {v0, v4}, Ljsl;->a(Landroid/content/DialogInterface;)V
...
.method protected a(Landroid/os/Parcelable;)V
    ...
    .line 219
    :cond_0
    invoke-super {p0, p1}, Ljsh;->a(Landroid/os/Parcelable;)V
    ...
    .line 224
    invoke-virtual {p1}, Ljsr;->getSuperState()Landroid/os/Parcelable;

    move-result-object v0

    invoke-super {p0, v0}, Ljsh;->a(Landroid/os/Parcelable;)V

    .line 225
    iget-boolean v0, p1, Ljsr;->a:Z

    if-eqz v0, :cond_1

    .line 226
    iget-object v0, p1, Ljsr;->b:Landroid/os/Bundle;
...
.method protected e()Landroid/os/Parcelable;
    ...
    .prologue
    .line 203
    invoke-super {p0}, Ljsh;->e()Landroid/os/Parcelable;
    ...
    invoke-direct {v0, v1}, Ljsr;-><init>(Landroid/os/Parcelable;)V

    .line 210
    const/4 v1, 0x1

    iput-boolean v1, v0, Ljsr;->a:Z
    ...
    iput-object v1, v0, Ljsr;->b:Landroid/os/Bundle;
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    invoke-virtual {v0, p1}, Ljsl;->b(Landroid/content/DialogInterface;)V
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .line 193
    invoke-virtual {v0, p0}, Ljrv;->a(Lcom/google/android/libraries/social/settings/PreferenceScreen;)V
