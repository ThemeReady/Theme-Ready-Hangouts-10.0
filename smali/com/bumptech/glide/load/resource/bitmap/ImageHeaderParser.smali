...
.method public constructor <init>(Ljava/io/InputStream;Laql;)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Laql;

    .line 100
    new-instance v0, Lawh;

    invoke-direct {v0, p1}, Lawh;-><init>(Ljava/io/InputStream;)V

    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lawg;

    .line 101
    return-void
.end method

.method public constructor <init>(Ljava/nio/ByteBuffer;Laql;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Lawe;-><init>(Ljava/nio/ByteBuffer;)V
...
.method private static a(Lawf;)I
    .locals 10
    ...
    .line 288
    invoke-virtual {p0, v1}, Lawf;->b(I)S
    ...
    .line 301
    :goto_0
    invoke-virtual {p0, v0}, Lawf;->a(Ljava/nio/ByteOrder;)V

    .line 303
    const/16 v0, 0xa

    invoke-virtual {p0, v0}, Lawf;->a(I)I
    ...
    .line 309
    invoke-virtual {p0, v3}, Lawf;->b(I)S
    ...
    invoke-virtual {p0, v5}, Lawf;->b(I)S
    ...
    invoke-virtual {p0, v6}, Lawf;->a(I)I
...
.method private d()I
    ...
    .line 246
    :cond_0
    iget-object v1, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lawg;

    invoke-interface {v1}, Lawg;->b()S
    ...
    .line 269
    iget-object v3, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lawg;

    int-to-long v4, v1

    invoke-interface {v3, v4, v5}, Lawg;->a(J)J
...
.method public b()Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser$ImageType;
    ...
    .line 116
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lawg;

    invoke-interface {v0}, Lawg;->a()I
    ...
    invoke-interface {v0, v2, v3}, Lawg;->a(J)J

    .line 129
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lawg;

    invoke-interface {v0}, Lawg;->c()I
    ...
    invoke-interface {v0, v6, v7}, Lawg;->a(J)J
...
.method public c()I
    ...
    .line 193
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Laql;
    ...
    invoke-interface {v3, v0, v2}, Lawg;->a([BI)I
    ...
    :cond_4
    :goto_2
    iget-object v2, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Laql;
    ...
    invoke-direct {v1, v0, v2}, Lawf;-><init>([BI)V

    invoke-static {v1}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->a(Lawf;)I
    :try_end_1
