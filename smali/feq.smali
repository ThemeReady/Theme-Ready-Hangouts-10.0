...
.method private a()V
    ...
    .line 191
    iget-object v1, p0, Lfeq;->b:Landroid/telephony/ServiceState;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lfeq;->c:Landroid/telephony/SignalStrength;

    if-eqz v1, :cond_0

    .line 192
    iget-object v3, p0, Lfeq;->a:Lfeo;

    iget-object v1, p0, Lfeq;->a:Lfeo;

    .line 3031
    iget-object v1, v1, Lfeo;->b:Landroid/content/Context;

    .line 192
    iget-object v4, p0, Lfeq;->b:Landroid/telephony/ServiceState;

    invoke-virtual {v4}, Landroid/telephony/ServiceState;->getState()I

    move-result v4

    iget-object v5, p0, Lfeq;->c:Landroid/telephony/SignalStrength;

    .line 193
    invoke-static {v5}, Lfeu;->a(Landroid/telephony/SignalStrength;)I

    move-result v5

    .line 192
    invoke-static {v1, v4, v5}, Lfeu;->a(Landroid/content/Context;II)Lfew;
...
.method public onServiceStateChanged(Landroid/telephony/ServiceState;)V
    ...
    .line 176
    :cond_0
    iput-object p1, p0, Lfeq;->b:Landroid/telephony/ServiceState;

    .line 177
    invoke-direct {p0}, Lfeq;->a()V
...
.method public onSignalStrengthsChanged(Landroid/telephony/SignalStrength;)V
    ...
    .line 186
    :cond_0
    iput-object p1, p0, Lfeq;->c:Landroid/telephony/SignalStrength;
