...
.method public static a(Landroid/content/ContentResolver;Landroid/net/Uri;I)Lagy;
    .locals 6
    ...
    invoke-direct {v0, p0, p1}, Lahc;-><init>(Landroid/content/ContentResolver;Landroid/net/Uri;)V
    ...
    invoke-static {v0, v3, v2}, Lahb;->a(Lahe;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    iput-object v0, v1, Lagy;->b:Landroid/graphics/Bitmap;
    ...
    invoke-direct {v0, p0, p1}, Lahe;-><init>(Landroid/content/ContentResolver;Landroid/net/Uri;)V
...
.method private static a(Lahe;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 9
    ...
    .line 147
    :try_start_0
    invoke-virtual {p0}, Lahe;->a()Ljava/io/InputStream;
    :try_end_0
