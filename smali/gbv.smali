...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgbv;->a:Ljava/lang/Object;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lgbv;->c:Ljava/util/List;

    sget-object v0, Ljava/util/Collections;->EMPTY_LIST:Ljava/util/List;

    iput-object v0, p0, Lgbv;->d:Ljava/util/List;

    sget-object v0, Ljava/util/Collections;->EMPTY_LIST:Ljava/util/List;

    iput-object v0, p0, Lgbv;->e:Ljava/util/List;

    sget-object v0, Ljava/util/Collections;->EMPTY_LIST:Ljava/util/List;

    iput-object v0, p0, Lgbv;->f:Ljava/util/List;

    :goto_0
    return-void

    :cond_0
    sget-object v0, Lgbx;->b:Lgvi;
    ...
    invoke-direct {v1, v4, v2, v3}, Lgca;-><init>(IJ)V

    iput-object v1, p0, Lgbv;->g:Lgca;
...
.method public static a()Lgbv;
    .locals 2

    sget-object v1, Lgbv;->a:Ljava/lang/Object;
...
.method private a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/content/Intent;I)V
    ...
    invoke-virtual {v2, v0}, Lgca;->b(Ljava/lang/String;)Z
    ...
    invoke-static {v2, v5}, Ldlm;->f(II)Ljava/lang/String;
    ...
    invoke-static {v5, v6}, Ldlm;->f(II)Ljava/lang/String;
    ...
    invoke-static {v6, v7}, Ldlm;->f(II)Ljava/lang/String;
    ...
    invoke-static/range {p1 .. p1}, Ldlm;->R(Landroid/content/Context;)Ljava/lang/String;
    ...
    iget-object v3, v0, Lgbv;->c:Ljava/util/List;
    ...
    iget-object v3, v0, Lgbv;->d:Ljava/util/List;
    ...
    iget-object v3, v0, Lgbv;->e:Ljava/util/List;
    ...
    iget-object v3, v0, Lgbv;->f:Ljava/util/List;
    ...
    invoke-virtual {v2, v0}, Lgca;->a(Ljava/lang/String;)Ljava/lang/Long;
...
.method private static b()I
    ...
    sget-object v0, Lgbv;->h:Ljava/lang/Integer;
    ...
    sput-object v0, Lgbv;->h:Ljava/lang/Integer;
    :try_end_0
...
.method public a(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    invoke-static {p2}, Lgbv;->a(Landroid/content/ServiceConnection;)Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v5}, Lgbv;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/content/Intent;I)V
...
.method public a(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    invoke-static {p1, v1}, Ldlm;->h(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p4}, Lgbv;->a(Landroid/content/ServiceConnection;)Ljava/lang/String;
