...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/Class;)V
    ...
    iput-object v0, p0, Lgrk;->b:Landroid/content/Context;

    iput-object p2, p0, Lgrk;->c:Ljava/lang/Class;

    return-void
.end method

.method static declared-synchronized a(Landroid/content/Context;Ljava/lang/Class;)Lgrk;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, Lgrk;-><init>(Landroid/content/Context;Ljava/lang/Class;)V
...
.method private a(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Lgrk;->b:Landroid/content/Context;

    iget-object v1, p0, Lgrk;->c:Ljava/lang/Class;
...
.method private b(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-static {p1, v0}, Lgrk;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lgrk;->b:Landroid/content/Context;
    ...
    invoke-static {v0}, Lgqy;->b(Landroid/os/Bundle;)V
...
.method private b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lgrk;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lgrk;->b:Landroid/content/Context;
    ...
    invoke-static {v3}, Lgrk;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lgrk;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method a(Landroid/os/Bundle;)Z
    ...
    invoke-direct {p0, p1, v0}, Lgrk;->b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v8, p0, Lgrk;->b:Landroid/content/Context;
    ...
    .line 1000
    :goto_1
    invoke-direct {p0, p1}, Lgrk;->b(Landroid/os/Bundle;)Landroid/app/PendingIntent;

    move-result-object v0

    invoke-static {p1}, Lgqy;->c(Landroid/os/Bundle;)Z
    ...
    invoke-direct {p0, v3, p1}, Lgrk;->a(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0, p1}, Lgrk;->a(Landroid/content/Intent;Landroid/os/Bundle;)V

    iget-object v9, p0, Lgrk;->b:Landroid/content/Context;
    ...
    iget-object v10, p0, Lgrk;->b:Landroid/content/Context;

    invoke-direct {v9, v10}, Lfb;-><init>(Landroid/content/Context;)V

    const/4 v10, 0x1

    invoke-virtual {v9, v10}, Lfb;->e(Z)Lfb;

    move-result-object v9

    invoke-virtual {v9, v5}, Lfb;->a(I)Lfb;
    ...
    invoke-virtual {v5, v6}, Lfb;->a(Ljava/lang/CharSequence;)Lfb;
    ...
    invoke-virtual {v5, v7}, Lfb;->b(Ljava/lang/CharSequence;)Lfb;
    ...
    invoke-virtual {v5, v6}, Lfb;->e(I)Lfb;

    :cond_1
    if-eqz v4, :cond_2

    invoke-virtual {v5, v4}, Lfb;->a(Landroid/net/Uri;)Lfb;

    :cond_2
    if-eqz v3, :cond_3

    invoke-virtual {v5, v3}, Lfb;->a(Landroid/app/PendingIntent;)Lfb;

    :cond_3
    if-eqz v0, :cond_4

    invoke-virtual {v5, v0}, Lfb;->b(Landroid/app/PendingIntent;)Lfb;

    :cond_4
    invoke-virtual {v5}, Lfb;->b()Landroid/app/Notification;
    ...
    .line 1000
    :cond_c
    iget-object v6, p0, Lgrk;->b:Landroid/content/Context;
    ...
    invoke-virtual {v5, v6}, Lfb;->a(Ljava/lang/CharSequence;)Lfb;
    :try_end_0
    .catch Lgrl; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v0}, Lgrl;->getMessage()Ljava/lang/String;
