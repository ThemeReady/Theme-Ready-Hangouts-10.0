...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Lzg;-><init>(Landroid/support/v7/widget/ActivityChooserView;)V
    ...
    invoke-direct {v0, p0}, Lzh;-><init>(Landroid/support/v7/widget/ActivityChooserView;)V
    ...
    .line 229
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Lzl;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->b:Lach;

    .line 232
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->b:Lach;

    invoke-virtual {v0}, Lach;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Lzl;
    ...
    invoke-direct {v2, p0, v0}, Lzi;-><init>(Landroid/support/v7/widget/ActivityChooserView;Landroid/view/View;)V
    ...
    .line 264
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lzk;

    .line 265
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lzk;

    new-instance v1, Lzj;

    invoke-direct {v1, p0}, Lzj;-><init>(Landroid/support/v7/widget/ActivityChooserView;)V

    invoke-virtual {v0, v1}, Lzk;->registerDataSetObserver(Landroid/database/DataSetObserver;)V
...
.method public a(Lln;)V
    ...
    .prologue
    .line 324
    iput-object p1, p0, Landroid/support/v7/widget/ActivityChooserView;->g:Lln;
...
.method public a(Lzb;)V
    ...
    invoke-virtual {v0, p1}, Lzk;->a(Lzb;)V
...
.method public b(I)V
    ...
    .line 356
    :goto_0
    iget-object v3, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lzk;

    invoke-virtual {v3}, Lzk;->c()I
    ...
    invoke-virtual {v3, v1}, Lzk;->a(Z)V
    ...
    invoke-virtual {v3, v4}, Lzk;->a(I)V

    .line 367
    :goto_2
    invoke-virtual {p0}, Landroid/support/v7/widget/ActivityChooserView;->d()Lacp;
    ...
    .line 370
    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lzk;

    invoke-virtual {v2, v1, v0}, Lzk;->a(ZZ)V

    .line 374
    :goto_3
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lzk;

    invoke-virtual {v0}, Lzk;->a()I
    ...
    .line 375
    invoke-virtual {v3, v0}, Lacp;->g(I)V

    .line 376
    invoke-virtual {v3}, Lacp;->a()V

    .line 377
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->g:Lln;
    ...
    .line 380
    :cond_2
    invoke-virtual {v3}, Lacp;->e()Landroid/widget/ListView;
    ...
    invoke-virtual {v3, v2}, Lzk;->a(Z)V

    .line 364
    iget-object v3, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lzk;

    invoke-virtual {v3, p1}, Lzk;->a(I)V
    ...
    invoke-virtual {v0, v2, v2}, Lzk;->a(ZZ)V
...
.method public d()Lacp;
    ...
    .prologue
    .line 504
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->q:Lacp;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->q:Lacp;

    .line 506
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->q:Lacp;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lzk;

    invoke-virtual {v0, v1}, Lacp;->a(Landroid/widget/ListAdapter;)V

    .line 507
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->q:Lacp;

    invoke-virtual {v0, p0}, Lacp;->a(Landroid/view/View;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Lzl;

    invoke-virtual {v0, v1}, Lacp;->a(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v1}, Lacp;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual {v0, v1}, Lzb;->registerObserver(Ljava/lang/Object;)V
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v0, v3, v3, v1, v2}, Lach;->layout(IIII)V
