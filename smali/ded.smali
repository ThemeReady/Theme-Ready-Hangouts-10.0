...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lded;->d:Ljava/util/concurrent/locks/ReadWriteLock;

    .line 3058
    iget-object v0, p0, Lded;->d:Ljava/util/concurrent/locks/ReadWriteLock;

    invoke-interface {v0}, Ljava/util/concurrent/locks/ReadWriteLock;->readLock()Ljava/util/concurrent/locks/Lock;

    move-result-object v0

    iput-object v0, p0, Lded;->e:Ljava/util/concurrent/locks/Lock;
    ...
    iput-object v0, p0, Lded;->f:Ljava/util/concurrent/locks/Lock;
...
.method public a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v0}, Lded;->a(Ljava/lang/String;Z)Ljava/lang/String;
...
.method a(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    .prologue
    .line 3079
    iget-object v0, p0, Lded;->f:Ljava/util/concurrent/locks/Lock;
    ...
    invoke-static {p1, v0, v1}, Ldlm;->a(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    .line 3095
    invoke-static {v1}, Ldlm;->H(Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lded;->a:Ljava/lang/String;
    ...
    .line 3108
    iget-object v3, p0, Lded;->b:Ljava/util/Map;
    ...
    .catch Lfle; {:try_start_0 .. :try_end_0} :catch_3
    .catch Lfld; {:try_start_0 .. :try_end_0} :catch_7
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_4
    .catch Lhwj; {:try_start_0 .. :try_end_0} :catch_6
    .catch Lhwi; {:try_start_0 .. :try_end_0} :catch_5
    ...
    .line 3140
    :cond_3
    iget-object v1, p0, Lded;->f:Ljava/util/concurrent/locks/Lock;
...
.method public b(Ljava/lang/String;)V
    ...
    .catch Lhwi; {:try_start_0 .. :try_end_0} :catch_6
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Lhwj; {:try_start_0 .. :try_end_0} :catch_7
    .catch Landroid/accounts/AuthenticatorException; {:try_start_0 .. :try_end_0} :catch_2
    .catch Landroid/accounts/OperationCanceledException; {:try_start_0 .. :try_end_0} :catch_3
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_4
    .catch Lfle; {:try_start_0 .. :try_end_0} :catch_5
...
.method public c(Ljava/lang/String;)Ljava/lang/Long;
    ...
    .prologue
    .line 2069
    iget-object v0, p0, Lded;->e:Ljava/util/concurrent/locks/Lock;
    ...
    .line 2073
    iget-object v1, p0, Lded;->e:Ljava/util/concurrent/locks/Lock;
