...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lhnz;->a:Ljava/util/Map;
    ...
    sput-object v0, Lhnz;->b:Ljava/lang/Iterable;
    ...
    sput-object v0, Lhnz;->c:Landroid/os/Handler;

    const/4 v0, 0x0

    new-array v0, v0, [Ljava/lang/String;

    sput-object v0, Lhnz;->d:[Ljava/lang/String;
    ...
    sput-object v0, Lhnz;->e:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lhnz;->f:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lhnz;->g:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lhnz;->h:Ljava/util/regex/Pattern;

    const-string v0, "\u0001"

    sput-object v0, Lhnz;->i:Ljava/lang/String;

    const-string v0, "\u0002"

    sput-object v0, Lhnz;->j:Ljava/lang/String;

    new-instance v0, Ljava/security/SecureRandom;

    invoke-direct {v0}, Ljava/security/SecureRandom;-><init>()V

    sput-object v0, Lhnz;->k:Ljava/security/SecureRandom;

    new-instance v0, Lhoa;

    invoke-direct {v0}, Lhoa;-><init>()V

    sput-object v0, Lhnz;->m:Ljava/lang/ThreadLocal;

    new-instance v0, Lhob;

    invoke-direct {v0}, Lhob;-><init>()V

    sput-object v0, Lhnz;->n:Ljava/lang/ThreadLocal;

    new-instance v0, Lhoc;

    invoke-direct {v0}, Lhoc;-><init>()V

    sput-object v0, Lhnz;->l:Ljava/lang/ThreadLocal;

    new-instance v0, Lhod;

    invoke-direct {v0}, Lhod;-><init>()V

    sput-object v0, Lhnz;->o:Ljava/lang/ThreadLocal;

    new-instance v0, Lhoe;

    invoke-direct {v0}, Lhoe;-><init>()V

    sput-object v0, Lhnz;->p:Ljava/lang/ThreadLocal;

    new-instance v0, Lhof;

    invoke-direct {v0}, Lhof;-><init>()V

    sput-object v0, Lhnz;->q:Ljava/lang/ThreadLocal;
...
.method public static a(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1}, Lhnz;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/StringBuilder;
...
.method public static a()Ljava/lang/StringBuilder;
    ...
    sget-object v0, Lhnz;->m:Ljava/lang/ThreadLocal;
...
.method private static a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v0, v2, p2}, Lhnz;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v1, v2, p2}, Lhnz;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/StringBuilder;
...
.method public static b(Ljava/lang/String;)[Ljava/lang/String;
    ...
    sget-object v0, Lhnz;->d:[Ljava/lang/String;

    :goto_0
    return-object v0

    :cond_0
    sget-object v0, Lhnz;->e:Ljava/util/regex/Pattern;
